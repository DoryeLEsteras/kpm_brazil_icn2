...
threads = 1
np = 20
structure_file = "ptse2_monolayer.vasp"
...
"""
dir_name = "/opt/project/dorye_projects/brazil_kpm/ptse2/structure"
create_dir(dir_name)
...
dir_name = "/opt/project/dorye_projects/brazil_kpm/ptse2/qe/soc/spin_textures"
create_dir(dir_name)
...
"""
dir_name = "/opt/project/dorye_projects/brazil_kpm/ptse2/qe/soc/dos"
create_dir(dir_name)
scf_file_name = os.path.join(dir_name, f"{exp_qe.exp_name}.scf.in")
exp_qe = create_qe_scf(scf_file_name, exp_qe)
